...
// *****************************************************************************
// load distribution class definition
...
class Main : public CBase_Main {
  ...
  public:
    Main( CkArgMsg* msg ) {
      ...
      tk LD;
      numChare = LD.linearLoadDistributor( virtualization,
                                           numPixel,
                                           CkNumPes(),
                                           chunksize,
                                           remainder );
      ...
      // call the chareArray
      mandelArray.computeMandel(chunksize, remainder, deltax);
...
class mandelChare : public CBase_mandelChare
{
        ...
        mandelChare(CkMigrateMessage* msg) { }

        void computeMandel(uint64_t chunksize, uint64_t remainder, double deltax)
        {
...
// *****************************************************************************
// load distribution class member functions
tk::tk()
{
        // constructor
}
